<template>
  ...
  >
    ...
    <div
      class="download-options p-6 rounded-2xl bg-gradient-to-br from-[var(--neon-purple)]/10 to-[var(--neon-blue)]/10"
    >
      <h3 class="text-2xl font-semibold text-[var(--text-light)] mb-4">
