      ...
      >
        ...
        >
          <span
            ...
            просто будет — оно уже практически здесь, оно витает в воздухе, его чувствуют
            разработчики, оно снится дизайнерам по ночам. Оно словно цифровой Единорог — мифическое,
            прекрасное и вот-вот появится. Говорят, кто однажды взглянет на превью, тот уже никогда
            не вернётся к Word. Превью обещано в пророчествах front-end разработчиков, и даже
            бэкэндер, проснувшись в 3 утра, однажды прошептал: «а где превью?..» Мы проводили обряд
            деплоя, мы чистили кэш, мы перезапускали vite, вы не представляете, сколько
            console.log() мы проложили на этом пути. Мы клянемся: оно появится здесь — точно по
            центру, с нежными тенями, с безупречной типографикой, с градиентной рамкой и кнопочкой
            «Скачать». Потому что если не здесь — то где? И если не сейчас — то когда (ну, максимум
            на следующем спринте)? Так что пока оно не появилось — насладитесь этой изысканной
            заглушкой, как напоминанием о прекрасном. И пусть она будет свидетельством нашей
            решимости и лёгкой прокрастинации.]</span
          >
        </div>
      </div>
